...
<html>
    <head>
        <link rel="stylesheet" type="text/css" href="Assets/ux.css">
          ...
          <div class="container text-center text-md-left">
              ...
              <div class="row text-center text-md-left mt-3 pb-3">
                  ...
                  <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                      ...
                      <p class="pass"><a href="#!">Become a Driver</a></p>
                  ...
                  <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                      ...
                      <p class="pass"><i class=" glyphicon glyphicon-envelope fa fa-home mr-3"></i> Socorro, NM 87801, US</p>
                      <p class="pass"><i class="fa fa-envelope mr-3"></i> info@nomad.com</p>
                      <p class="pass"><i class="fa fa-phone mr-3"></i> + 01 234 567 88</p>
                      <p class="pass"><i class="fa fa-print mr-3"></i> + 01 234 567 89</p>
                  </div>
                  <!--/.Fourth column-->
